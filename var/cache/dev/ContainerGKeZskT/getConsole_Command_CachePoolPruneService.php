...
class getConsole_Command_CachePoolPruneService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['console.command.cache_pool_prune'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\CachePoolPruneCommand(new RewindableGenerator(function () use ($container) {
            ...
            yield 'cache.doctrine.orm.reports.metadata' => ($container->privates['cache.doctrine.orm.reports.metadata'] ?? $container->getCache_Doctrine_Orm_Reports_MetadataService());
            yield 'cache.doctrine.orm.reports.result' => ($container->privates['cache.doctrine.orm.reports.result'] ?? $container->getCache_Doctrine_Orm_Reports_ResultService());
            yield 'cache.doctrine.orm.reports.query' => ($container->privates['cache.doctrine.orm.reports.query'] ?? $container->getCache_Doctrine_Orm_Reports_QueryService());
