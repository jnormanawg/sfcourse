 ...
 */
class getTEPSITERepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TEPSITERepository' shared autowired service.
     *
     * @return \App\Repository\TEPSITERepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TEPSITERepository.php';

        return $container->privates['App\\Repository\\TEPSITERepository'] = new \App\Repository\TEPSITERepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
