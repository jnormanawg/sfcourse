 ...
 */
class getTEPORGANIZATIONRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TEPORGANIZATIONRepository' shared autowired service.
     *
     * @return \App\Repository\TEPORGANIZATIONRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TEPORGANIZATIONRepository.php';

        return $container->privates['App\\Repository\\TEPORGANIZATIONRepository'] = new \App\Repository\TEPORGANIZATIONRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
