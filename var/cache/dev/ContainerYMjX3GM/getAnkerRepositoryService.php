 ...
 */
class getAnkerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AnkerRepository' shared autowired service.
     *
     * @return \App\Repository\AnkerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AnkerRepository.php';

        return $container->privates['App\\Repository\\AnkerRepository'] = new \App\Repository\AnkerRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
