...
/* post/show.html.twig */
class __TwigTemplate_3ed76edb244ab00396d053e9b8287a61974f5f4249a844ce0cebf1d9efdfeec2 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table table-striped\">
        ...
        echo "</td>
                <td><a href=\"";
        // line 15
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("post.show", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 15, $this->source); })()), "id", [], "any", false, false, false, 15)]), "html", null, true);
        echo "\">";
...
";
    ...
    {
        return array (  75 => 15,  71 => 14,  59 => 4,  52 => 3,  35 => 1,);
    }
...
{% endblock %}", "post/show.html.twig", "C:\\Apache2.4\\htdocs\\sfcourse\\templates\\post\\show.html.twig");
    }
}
