...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'doctrine.dbal.reports_connection' => 'getDoctrine_Dbal_ReportsConnectionService',
            'doctrine.orm.default_entity_manager' => 'getDoctrine_Orm_DefaultEntityManagerService',
            'doctrine.orm.reports_entity_manager' => 'getDoctrine_Orm_ReportsEntityManagerService',
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Admin\\TEPORGANIZATIONCrudController' => 'getTEPORGANIZATIONCrudControllerService',
            'App\\Controller\\Admin\\UserCrudController' => 'getUserCrudControllerService',
            'App\\Controller\\AnkerController' => 'getAnkerControllerService',
            'App\\Controller\\HomesController' => 'getHomesControllerService',
            ...
            'App\\Controller\\ReportsController' => 'getReportsControllerService',
            ...
            'doctrine.dbal.customer_connection' => 'getDoctrine_Dbal_CustomerConnectionService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('mx07eAUQfl', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventSubscriber(($this->privates['doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber'] ?? ($this->privates['doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber'] = new \Symfony\Bridge\Doctrine\SchemaListener\PdoCacheAdapterDoctrineSchemaSubscriber([]))));
    ...
    /**
     * Gets the public 'doctrine.dbal.reports_connection' shared service.
     *
     * @return \Doctrine\DBAL\Connection
     */
    protected function getDoctrine_Dbal_ReportsConnectionService()
    {
        $a = new \Doctrine\DBAL\Configuration();

        $b = new \Doctrine\DBAL\Logging\LoggerChain();
        $b->addLogger(($this->privates['doctrine.dbal.logger'] ?? $this->getDoctrine_Dbal_LoggerService()));
        $b->addLogger(($this->privates['doctrine.dbal.logger.profiling.reports'] ?? ($this->privates['doctrine.dbal.logger.profiling.reports'] = new \Doctrine\DBAL\Logging\DebugStack())));

        $a->setSQLLogger($b);
        $c = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'doctrine.orm.reports_listeners.attach_entity_listeners' => ['privates', 'doctrine.orm.reports_listeners.attach_entity_listeners', 'getDoctrine_Orm_ReportsListeners_AttachEntityListenersService', true],
        ], [
            'doctrine.orm.reports_listeners.attach_entity_listeners' => '?',
        ]));
        $c->addEventSubscriber(($this->privates['doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber'] ?? ($this->privates['doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber'] = new \Symfony\Bridge\Doctrine\SchemaListener\PdoCacheAdapterDoctrineSchemaSubscriber([]))));
        $c->addEventListener([0 => 'loadClassMetadata'], 'doctrine.orm.reports_listeners.attach_entity_listeners');

        return $this->services['doctrine.dbal.reports_connection'] = ($this->privates['doctrine.dbal.connection_factory'] ?? ($this->privates['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([])))->createConnection(['url' => $this->getEnv('DATABASE_REPORTS_URL'), 'driver' => 'pdo_mysql', 'charset' => 'utf8mb4', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'serverVersion' => '5.7', 'defaultTableOptions' => []], $a, $c, []);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setEntityNamespaces(['Main' => 'App\\Entity']);
    ...
    /**
     * Gets the public 'doctrine.orm.reports_entity_manager' shared service.
     *
     * @return \Doctrine\ORM\EntityManager
     */
    protected function getDoctrine_Orm_ReportsEntityManagerService($lazyLoad = true)
    {
        $a = new \Doctrine\ORM\Configuration();

        $b = new \Doctrine\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), [0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity'.\DIRECTORY_SEPARATOR.'Reports')]), 'App\\Entity\\Reports');

        $a->setEntityNamespaces(['Reports' => 'App\\Entity\\Reports']);
        $a->setMetadataCacheImpl(new \Symfony\Component\Cache\DoctrineProvider(($this->privates['cache.doctrine.orm.reports.metadata'] ?? $this->getCache_Doctrine_Orm_Reports_MetadataService())));
        $a->setQueryCacheImpl(new \Symfony\Component\Cache\DoctrineProvider(($this->privates['cache.doctrine.orm.reports.query'] ?? $this->getCache_Doctrine_Orm_Reports_QueryService())));
        $a->setResultCacheImpl(new \Symfony\Component\Cache\DoctrineProvider(($this->privates['cache.doctrine.orm.reports.result'] ?? $this->getCache_Doctrine_Orm_Reports_ResultService())));
        $a->setMetadataDriverImpl($b);
        $a->setProxyDir(($this->targetDir.''.'/doctrine/orm/Proxies'));
        $a->setProxyNamespace('Proxies');
        $a->setAutoGenerateProxyClasses(false);
        ...
        $this->services['doctrine.orm.reports_entity_manager'] = $instance = \Doctrine\ORM\EntityManager::create(($this->services['doctrine.dbal.reports_connection'] ?? $this->getDoctrine_Dbal_ReportsConnectionService()), $a);
    ...
    protected function getProfilerService()
    {
        ...
        $d->addInstance('cache.doctrine.orm.reports.metadata', ($this->privates['cache.doctrine.orm.reports.metadata'] ?? $this->getCache_Doctrine_Orm_Reports_MetadataService()));
        $d->addInstance('cache.doctrine.orm.reports.result', ($this->privates['cache.doctrine.orm.reports.result'] ?? $this->getCache_Doctrine_Orm_Reports_ResultService()));
        $d->addInstance('cache.doctrine.orm.reports.query', ($this->privates['cache.doctrine.orm.reports.query'] ?? $this->getCache_Doctrine_Orm_Reports_QueryService()));
        ...
        $e->addLogger('customer', ($this->privates['doctrine.dbal.logger.profiling.customer'] ?? ($this->privates['doctrine.dbal.logger.profiling.customer'] = new \Doctrine\DBAL\Logging\DebugStack())));
        $e->addLogger('reports', ($this->privates['doctrine.dbal.logger.profiling.reports'] ?? ($this->privates['doctrine.dbal.logger.profiling.reports'] = new \Doctrine\DBAL\Logging\DebugStack())));
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('J9+vpRz6mM', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    /**
     * Gets the private 'cache.doctrine.orm.reports.metadata' shared service.
     *
     * @return \Symfony\Component\Cache\Adapter\TraceableAdapter
     */
    protected function getCache_Doctrine_Orm_Reports_MetadataService()
    {
        return $this->privates['cache.doctrine.orm.reports.metadata'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(new \Symfony\Component\Cache\Adapter\ArrayAdapter());
    }

    /**
     * Gets the private 'cache.doctrine.orm.reports.query' shared service.
     *
     * @return \Symfony\Component\Cache\Adapter\TraceableAdapter
     */
    protected function getCache_Doctrine_Orm_Reports_QueryService()
    {
        return $this->privates['cache.doctrine.orm.reports.query'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(new \Symfony\Component\Cache\Adapter\ArrayAdapter());
    }

    /**
     * Gets the private 'cache.doctrine.orm.reports.result' shared service.
     *
     * @return \Symfony\Component\Cache\Adapter\TraceableAdapter
     */
    protected function getCache_Doctrine_Orm_Reports_ResultService()
    {
        return $this->privates['cache.doctrine.orm.reports.result'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(new \Symfony\Component\Cache\Adapter\ArrayAdapter());
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('aWL0lJsQr5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bDUk21XeJX', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tTjR4FULN3', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('088EsCZwHO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    protected function getDoctrine_Orm_ContainerRepositoryFactoryService()
    {
        return $this->privates['doctrine.orm.container_repository_factory'] = new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\AnkerRepository' => ['privates', 'App\\Repository\\AnkerRepository', 'getAnkerRepositoryService', true],
            ...
            'App\\Repository\\TEPORGANIZATIONRepository' => ['privates', 'App\\Repository\\TEPORGANIZATIONRepository', 'getTEPORGANIZATIONRepositoryService', true],
            'App\\Repository\\TEPSITERepository' => ['privates', 'App\\Repository\\TEPSITERepository', 'getTEPSITERepositoryService', true],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', true],
        ], [
            'App\\Repository\\AnkerRepository' => '?',
            'App\\Repository\\OrganizationRepository' => '?',
            'App\\Repository\\PostRepository' => '?',
            'App\\Repository\\TEPORGANIZATIONRepository' => '?',
            'App\\Repository\\TEPSITERepository' => '?',
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $a = new \Symfony\Component\PropertyInfo\PropertyInfoExtractor(new RewindableGenerator(function () {
            ...
            yield 2 => ($this->privates['doctrine.orm.reports_entity_manager.property_info_extractor'] ?? $this->load('getDoctrine_Orm_ReportsEntityManager_PropertyInfoExtractorService'));
            ...
            yield 1 => ($this->privates['doctrine.orm.reports_entity_manager.property_info_extractor'] ?? $this->load('getDoctrine_Orm_ReportsEntityManager_PropertyInfoExtractorService'));
        ...
        $instance->addLoader(new \Symfony\Bridge\Doctrine\Validator\DoctrineLoader(($this->services['doctrine.orm.reports_entity_manager'] ?? $this->getDoctrine_Orm_ReportsEntityManagerService()), NULL));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'doctrine.entity_managers' => [
                ...
                'reports' => 'doctrine.orm.reports_entity_manager',
            ],
            ...
            'doctrine.connections' => [
                ...
                'reports' => 'doctrine.dbal.reports_connection',
            ],
